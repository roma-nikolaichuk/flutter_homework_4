...
abstract class DeviceInfoPlatform extends PlatformInterface {
  ...
  Future<String?> getPlatformBrand() {
    throw UnimplementedError('platformBrand() has not been implemented.');
  }

  Future<String?> getPlatformModel() {
    throw UnimplementedError('platformModel() has not been implemented.');
  }

  Future<String?> getPlatformDevice() {
    throw UnimplementedError('platformDevice() has not been implemented.');
  }

  Future<String?> getPlatformDisplay() {
    throw UnimplementedError('platformDisplay() has not been implemented.');
  }
}
